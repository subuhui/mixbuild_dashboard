...
typedef BuildTriggerHandler = Future<RemoteBuildTriggerResult> Function(
...
class BuildTriggerServer {
  ...
  Future<void> _handleRequest(HttpRequest request) async {
    if (request.method != 'POST' || request.uri.path != '/build') {
      _writeJson(
        request,
        HttpStatus.notFound,
        <String, Object?>{'accepted': false, 'message': 'Not found'},
      );
      return;
    }
    ...
    try {
      ...
      _writeJson(
        ...
        <String, Object?>{'accepted': false, 'message': '$error'},
      );
    }
  }
  ...
  void _writeBadRequest(HttpRequest request, String message) {
    _writeJson(
      ...
      <String, Object?>{'accepted': false, 'message': message},
    );
  }
